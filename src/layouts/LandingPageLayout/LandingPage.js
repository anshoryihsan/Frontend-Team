        ...
        <Row>
          <Col lg={12} md={6} className="landing px-5 d-lg-block">
            ...
            <div className="d-flex">
              <div
                className="col col-lg-8 justify-content-start text"
                width="400px"
              >
                ...
                <button className="bg-white text-primary try">
                  Try It Free
                </button>
              </div>
              <div className="col col-lg-4 justify-content-end img">
                <img
                  src={
                    ...
                    "/zwallet/assets/images/img/png-phone.svg"
                  }
                  height="280em"
                  width="190em"
                  alt="images"
        ...
        <Row>
          <div className="brand d-flex justify-content-center">
            <img
              ...
              src={
                window.location.origin +
                "/zwallet/assets/images/img/microsoft.svg"
              }
              height="45em"
              width="50em"
              alt="images"
            ...
            <img
              ...
              src={
                window.location.origin +
                "/zwallet/assets/images/img/dropbox.svg"
              }
              height="45em"
              width="50em"
              alt="images"
            ...
            <img
              className="mr-3 mt-4"
              src={
                window.location.origin + "/zwallet/assets/images/img/h&m.svg"
              }
              height="25em"
              width="30em"
              alt="images"
            ...
            <img
              className="mr-3 mt-3"
              src={
                window.location.origin + "/zwallet/assets/images/img/airbnb.svg"
              }
              height="45em"
              width="50em"
              alt="i
          mages"
            ...
            <img
              className="mr-3 mt-3"
              src={
                window.location.origin + "/zwallet/assets/images/img/canon.svg"
              }
              height="45em"
              width="50em"
              alt="images"
            ...
            <img
              className="mt-3"
              src={
                window.location.origin + "/zwallet/assets/images/img/dell.svg"
              }
              height="45em"
              width="50em"
              alt="images"
        ...
        <Row>
          <div className="about bg-secondary col cl-lg-12 col-sm-12 flex-column d-flex justify-content-center align-items-center">
            ...
            <div className="desc text-center">
              <p>
                We have some garde features from the application and it's
                totally free
              </p>
            ...
            <div className="shadow-sm bg-white rounded-14 pl-3 pr-3 my-4 py-3 mx-2">
              <div className="bg-gray d-flex justify-content-center icons">
                <img
                  ...
                  src={
                    window.location.origin +
                    "/zwallet/assets/images/img/phone.svg"
                  }
                  height="15em"
                  width="15em"
                  alt="images"
            ...
            <div className="shadow-sm bg-white rounded-14 pl-3 pr-3 my-4 py-3 mx-2">
              <div className="bg-gray d-flex justify-content-center icons">
                <img
                  ...
                  src={
                    window.location.origin +
                    "/zwallet/assets/images/img/lock.svg"
                  }
                  height="15em"
                  width="15em"
                  alt="images"
            ...
            <div className="shadow-sm bg-white rounded-14 pl-3 pr-3 my-4 py-3 mx-2">
              <div className="bg-gray d-flex justify-content-center icons">
                <img
                  ...
                  src={
                    window.location.origin +
                    "/zwallet/assets/images/img/download.svg"
                  }
                  height="15em"
                  width="15em"
                  alt="images"
        ...
        <Row>
          <div className="features d-flex col col-sm-12">
            <div className="col col-lg-4 justify-content-end">
              <img
                className="img-features1"
                src={
                  window.location.origin +
                  "/zwallet/assets/images/img/png-phone2.svg"
                }
                height="180em"
                width="200em"
                alt="images"
            ...
            <div
              className="col col-lg-8 justify-content-start desc-features"
              width="400px"
            >
              ...
              <div className="shadow-sm bg-white rounded-14 pl-3 pr-3 my-4 py-3 mx-2">
                <p className="font-weight-bold sub-desc-features1">
                  <span className="text-primary">1. </span>Small Fee
                </p>
                <p className="sub-desc-features2">
          ...
          <div className="about bg-secondary col cl-lg-12 col-sm-12 flex-column d-flex justify-content-center align-items-center">
            ...
            <div className="d-flex">
              <img
                className="img-left"
                src={
                  window.location.origin + "/zwallet/assets/images/img/left.svg"
                }
                height="60px"
                width="60px"
                alt="images"
              ...
              <div className="shadow-sm bg-white rounded-14 pl-3 pr-3 my-4 py-3 mx-2">
                <div className="d-flex justify-content-center">
                  <img
                    src={
                      window.location.origin +
                      "/zwallet/assets/images/img/1.png"
                    }
                    height="40em"
                    width="40em"
                    alt="images"
                ...
                <div className="note-person text-center">
                  <p>
                    "This is tehe most outstanding app that i've every time in
                    my live, this app is such an amazing masterpiece and
                  </p>
                  <p>
                    it's suitable for you who is bussy with there bussiness and
                    must transfer money to another person aut there.
                  </p>
              ...
              <img
                ...
                src={
                  window.location.origin +
                  "/zwallet/assets/images/img/right.svg"
                }
                height="60px"
                width="60px"
                alt="images"
