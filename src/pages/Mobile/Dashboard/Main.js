  ...
  return (
    <div className="bg-secondary vh-100">
      <nav className="d-flex justify-content-between">
        ...
        <Link to="/m/dashboard/notification" className="btn">
          <img
            alt="notification"
            src={
              window.location.origin + "/zwallet/assets/images/icons/bell.svg"
            }
            height="24px"
            width="24px"
          />
        ...
        <div className="col-6 pl-2">
          ...
          >
            <img
              src={
                window.location.origin +
                "/zwallet/assets/images/icons/plus-active.svg"
              }
              height="24px"
              width="24px"
              alt="plus"
      ...
      <div className="d-flex justify-content-between my-4 mx-2">
        ...
        <Link to="/m/dashboard/transaction" className="text-primary small">
          See All
        </Link>
      </div>
